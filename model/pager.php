...
class pagination{
	...
	private $_nItemOnPage; // s? lu?ng item trong 1 page
	...
	public function showPagination(){
		...
		if($this->_totalPage > 1){
			...
			if($this->_currentPage > 1){
				...
				$prev 	= "<li><a href='$actual_link&page=".($this->_currentPage-1)."'><span aria-hidden='true'>&laquo;</span></a></li>";
			}
			$next 	= '';
			$end 	= '';
			if($this->_currentPage < $this->_totalPage){
				$next 	= "<li><a href='$actual_link&page=".($this->_currentPage+1)."'><span aria-hidden='true'>&raquo;</span></a></li>";
